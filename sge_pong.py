...
#                          color=sge.gfx.Color("gray"))
    ...
    def grab_screenshot(self):
        return pygame.surfarray.array2d( sge.gfx.Sprite.from_screenshot() )
...
# Create Game object
Game(width=160, height=120, fps=60, window_text="Pong")

# Load sprites
paddle_sprite = sge.gfx.Sprite(width=3, height=24, origin_x=2, origin_y=24)
ball_sprite = sge.gfx.Sprite(width=3, height=4, origin_x=2, origin_y=4)
paddle_sprite.draw_rectangle(0, 0, paddle_sprite.width, paddle_sprite.height,
                             fill=sge.gfx.Color("white"))
ball_sprite.draw_rectangle(0, 0, ball_sprite.width, ball_sprite.height,
                           fill=sge.gfx.Color("white"))
hud_sprite = sge.gfx.Sprite(width=160, height=60, origin_x=80, origin_y=20)
...
# Load fonts
hud_font = sge.gfx.Font("Droid Sans Mono", size=24)
